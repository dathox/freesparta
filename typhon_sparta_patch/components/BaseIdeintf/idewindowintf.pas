...
var
  ...
  CT_USE_DOCKING_SYSTEM      : boolean = TRUE; //======= ct9999 ============= for CodeTyphon Studio
  CT_USE_EMBEDDED_DESIGNER   : boolean = TRUE; //======= ct9999 ============= for CodeTyphon Studio
  CT_USE_AUTORENAME_PKGS     : boolean = TRUE; //======= ct9999 ============= for CodeTyphon Studio
  CT_SEND_MSG_TO_MESSAGESWIN : boolean = TRUE; //======= ct9999 ============= for CodeTyphon Studio
