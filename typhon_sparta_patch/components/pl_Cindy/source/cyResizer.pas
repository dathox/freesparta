...
begin
  ...
  ParentColor := false;  // Avoid flickering !!!
...
begin
  ...
  then begin
    ...
    then begin
      // DaThoX begin
      repeat
        FOnControlListInsert(Self, FLastMouseDownControl, ControlAccepted);
        if not ControlAccepted then
           FLastMouseDownControl := FLastMouseDownControl.GetParentComponent as TControl;
      until ControlAccepted or (FLastMouseDownControl = FSurface);
      // DaThoX end
      ...
      then begin
        ...
        then begin
          ...
          then begin
            ...
            // DaThoX begin
            repeat
              FOnControlListInsert(Self, FLastMouseDownControl{aHandlingControl}, ControlAccepted);
              if not ControlAccepted then
                 FLastMouseDownControl := FLastMouseDownControl.GetParentComponent as TControl;
            until ControlAccepted or (FLastMouseDownControl = FSurface);
            // DaThoX end
