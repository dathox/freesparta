...
type
  ...
  protected
    ...
    FIsActive:boolean;                            //============ ct9999 ================
    Procedure SetIsActive(const val: boolean);  //============ ct9999 ================
  ...
  public
    ...
    property IsActive:boolean read FisActive write SetIsActive; //============ ct9999 ================
...
Procedure TDesigner.SetIsActive(const val: boolean);
begin
  FisActive:=val;
