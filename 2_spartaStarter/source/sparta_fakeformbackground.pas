...
uses
  Classes, SysUtils, FileUtil, BGRAButton,
  BGRAImageButton, Forms, Controls, StdCtrls, ExtCtrls, Menus, sparta_DesignedForm,
...
type
  ...
  TfrFakeFormBackground = class(TFrame, IDesignedFormBackground)
    bBackground: TBGRAButton;
    bTop: TBGRAButton;
    bFormCaption: TBGRAButton;
    bOther: TBGRAImageButton;
    bResize: TBGRAImageButton;
    bIcon: TBGRAImageButton;
    bSystem: TBGRAImageButton;
    bMaximalize: TBGRAImageButton;
    bMinimalize: TBGRAImageButton;
    bHelp: TBGRAImageButton;
    eFormCaption: TEdit;
    lRight: TLabel;
    miNone: TMenuItem;
    miSingle: TMenuItem;
...
begin
  ...
  if FDesignedFakeForm.BorderStyle in [bsSizeable, bsSizeToolWin] then
    LoadPng(bResize.Bitmap, 'form_bg_resize')
  else
    LoadPng(bResize.Bitmap, 'form_bg_noresize');
