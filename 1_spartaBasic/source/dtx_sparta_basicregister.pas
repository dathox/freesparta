...
uses
  ...
  Buttons, ExtCtrls, Graphics, Generics.Defaults, IDEWindowIntf, sparta_MainIDE,
...
procedure Register;
begin
  FormEditingHook.StandardDesignerBaseClasses[STD_DESIGNER_BASE_TFORM_CLASS_ID] := TFakeForm;
  FormEditingHook.NonFormProxyDesignerForm[NON_CONTROL_PROXY_DESIGNER_FORM_ID] := TFakeNonControl;
  FormEditingHook.NonFormProxyDesignerForm[FRAME_PROXY_DESIGNER_FORM_ID] := TFakeFrame;
