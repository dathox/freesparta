...
uses
  Forms, Classes, SysUtils, Controls, ComCtrls, ComponentReg, ExtCtrls, Buttons, FormEditingIntf, Math,
  Generics.Collections, LazIDEIntf, PropEdits, LResources, LCLType, Graphics;
...
begin
  ...
  begin
    IDEComponentPalette.SetSelected(LComponent, ssShift in GetKeyShiftState);
  ...
  begin
    IDEComponentPalette.SetSelected(nil, false);
