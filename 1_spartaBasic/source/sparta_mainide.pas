...
uses
  ...
  Buttons, ExtCtrls, Graphics, Generics.Defaults, Generics.Collections, IDEWindowIntf,
  sparta_DesignedForm, sparta_resizer, PropEdits, PropEditUtils, FormEditingIntf, ComponentEditors, EditBtn,

  TypInfo,

  LCLIntf, LCLType, LMessages, sparta_FakeForm, sparta_FakeFrame, sparta_ComponentPalette, SpartaAPI;
...
begin
  ...
  LChildSite := TCustomForm(LazarusIDE.GetMainBar).DockManager.GetChildSite;
